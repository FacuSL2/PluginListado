...
function stm_listings_register_manager( $butterbean, $post_type ) {
	...
	$manager->register_control(
		'additional_features',
		array(
			'type'    => ( defined( 'ELEMENTOR_VERSION' ) && ! empty( apply_filters( 'stm_me_get_nuxy_mod', array(), 'fs_user_features' ) ) ) ? 'grouped_checkboxes' : 'checkbox_repeater',
	...
	if ( apply_filters( 'stm_me_get_nuxy_mod', true, 'enable_office_location_fee' ) ) {
		$manager->register_control(
			...
			array(
				'type'    => 'number',
				'section' => 'stm_info',
				'label'   => esc_html__( 'Office Fee', 'stm_vehicles_listing' ),
				'attr'    => array(
					'class' => 'widefat',
				),
			)
...
function stm_listings_register_manager_product( $butterbean, $post_type ) {
	...
	$manager->register_control(
		...
		array(
			'type'    => 'number',
			'section' => 'stm_info',
			'label'   => esc_html__( 'Minimum rent days', 'stm_vehicles_listing' ),
			'description' => esc_html__( 'Enter number of minimum days for rent', 'stm_vehicles_listing' ),
			'attr'    => array( 'class' => 'widefat' ),
		)
	);
	...
	$manager->register_control(
		...
		array(
			'type'    => 'number',
			'section' => 'stm_info',
			'label'   => esc_html__( 'Maximum rent days', 'stm_vehicles_listing' ),
			'description' => esc_html__( 'Enter number of maximum days for rent', 'stm_vehicles_listing' ),
			'attr'    => array( 'class' => 'widefat' ),
		)
	);
