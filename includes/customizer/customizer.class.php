...
if ( ! class_exists( 'STM_Customizer_Vehicle' ) ) {
	class STM_Customizer_Vehicle {
		...
		public static function customizer_preview_scripts() {
			wp_enqueue_script( 'stm-customizer-preview.js', STM_VEHICLE_CUSTOMIZER_URI . '/assets/js/customizer-preview.js', array(
				'jquery',
				'customize-preview'
			), STM_LISTING_VESRION, true );
		}
		...
		public static function admin_enqueue_scripts() {
			...
			wp_enqueue_script( 'stm-customizer.js', STM_VEHICLE_CUSTOMIZER_URI . '/assets/js/customizer.js', array(
				'customize-controls',
				'wp-color-picker'
			), STM_LISTING_VESRION, true );
			...
			foreach ( $sections as $section => $section_data ) {
				...
				if ( ! empty( $section_data['fields'] ) ) {
					foreach ( $section_data['fields'] as $field => $field_data ) {
						self::register_control( $field, $section, $field_data );
					}
				}
		...
		public static function register_control( $field, $section, $field_data = array() ) {
