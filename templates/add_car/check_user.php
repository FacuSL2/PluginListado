	...
	<div class="stm-form-inner">
		...
		if ( is_user_logged_in() ) :
			...
			<div id="stm_user_info">
				<?php do_action( 'stm_listings_load_template', 'add_car/registered' ); ?>
			</div>
			<?php
		else :
			$disabled = 'disabled';
				...
				<div class="stm-login-form">
					<form method="post">
						...
						<div class="form-group">
							...
							<input class="form-control" type="text" name="stm_user_login" placeholder="<?php esc_html_e( 'Enter login or E-mail', 'stm_vehicles_listing' ); ?>">
						</div>

						<div class="form-group">
							<h4><?php esc_html_e( 'Password', 'stm_vehicles_listing' ); ?></h4>
							<input class="form-control" type="password" name="stm_user_password" placeholder="<?php esc_html_e( 'Enter password', 'stm_vehicles_listing' ); ?>">
						</div>
