	...
	<div class="single-car-prices">
		<div class="single-regular-price text-center">
			<?php if ( ! empty( $regular_price_label ) ) : ?>
				<span class="labeled"><?php echo esc_html( $regular_price_label ); ?></span>
			<?php endif; ?>
...
<?php if ( $show_price && $show_sale_price ) : ?>
				...
				<tr>
					<td>
						<div class="regular-price-with-sale">
							<?php if ( ! empty( $special_price_label ) ) : ?>
								<?php esc_html( $special_price_label ); ?>
							<?php endif; ?>
							<?php if ( ! empty( $car_price_form_label ) ) : ?>
					...
					<td>
						...
						if ( ! empty( $regular_price_label ) ) :
							esc_html( $regular_price_label );
							$mg_bt = '';
						else :
							$mg_bt = 'style=margin-top:0';
						endif;
						?>
						<div class="h4" <?php echo esc_attr( $mg_bt ); ?>><?php echo esc_attr( apply_filters( 'stm_filter_price_view', '', $sale_price ) ); ?></div>
					</td>
				</tr>
			</table>
		</div>
	...
	<?php if ( ! empty( $instant_savings_label ) ) : ?>
		...
		<div class="sale-price-description-single">
			<?php esc_html( $instant_savings_label ); ?>
			<strong> <?php echo esc_attr( apply_filters( 'stm_filter_price_view', '', $savings ) ); ?></strong>
		</div>
	<?php endif; ?>
	<?php
endif;
